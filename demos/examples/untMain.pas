...
uses
  ...
  JvColorBox, JvColorButton, Mask, JvExMask, JvToolEdit, JvSpin, OrganizationChart,
  JvGradient;
...
begin
   if OrganizationChart.SelectedNode<>nil then begin
       OrganizationChart.SelectedNode.NodeShape := TOrganizationNodeShapeType(cmbshape.ItemIndex);
   end;
end;
...
begin
    if radStraight.Checked=true then OrganizationChart.LinkDrawType := ltStraight
    else OrganizationChart.LinkDrawType := ltSquared;
end;
